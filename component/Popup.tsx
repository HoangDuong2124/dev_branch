      ...
      >
        <div className="w-full h-auto px-2  flex justify-between items-center border-b">
          <div className="h-full flex items-center">
            {iconHeader.map((item) => (
              <div
                ...
                className="relative px-[8px] py-[8px] rounded-[4px] hover:bg-slate-200 text-[14px] leading-[21px]"
              >
          ...
          <div
            ...
            className=" px-[8px] py-[8px] rounded-[4px] hover:bg-slate-200 text-[14px] leading-[21px] "
          >
...
const Custom = ({
  ...
  return (
    <>
      <div className="w-full px-[12px] flex items-center justify-between my-[16px] ">
      ...
      <div
        role="button"
        className="max-w-full h-[32px] ml-[12px] mr-[12px] mt-[10px] flex justify-center items-center hover:bg-slate-300 border rounded-[5px] relative"
      >
        <input
          type="file"
